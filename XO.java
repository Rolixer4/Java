...
class XO {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Сыграем в крекстики-нолики!");
        ...
        while(!gameEnded) {
            ...
            if(player1) {
                System.out.println("Ход игрока: " + p1);
            } else {
                System.out.println("Ход игрока: " + p2);
            }
            ...
            while(true) {
                ...
                if(row < 0 || col < 0 || row >= n || col >= n) {
                    System.out.println("Эта позиция за пределами поля!");
